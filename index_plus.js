...
const ACCOUNT = { //账号相关，安全性更高
  ...
  "user" : "admin", //博客后台用户名
  "password" : "DZY@013520", //博客后台密码
  "third_token" : "cfblog", //开放token，当前仅允许访问/admin/search.xml，/admin/sitemap.xml时可用，在cfblog_token的头信息中传递
  "cacheZoneId":"ce8398a40becb9f1ebc8b2b35a409370",//区域 ID
  "cacheToken":"JV2r0PkUByFdf7hVaFxW9rZUdoi5H7G7FRyHpbuS",//API token

  "kv_var": "CFBLOG",//workers绑定kv时用的变量名
}

const OPT = { //网站配置

  /*--前台参数--*/
  "siteDomain" : "blogjetcpp.dpdns.org",// 域名(不带https 也不带/)
  "siteName" : "app blog",//博客名称
  "siteDescription":"纯净系统，纯净软件，纯净的生活" ,//博客描述
  "keyWords":"app,system",//关键字
  "logo":"https://cdn.jsdelivr.net/gh/Arronlong/cfblog-plus@master/themes/JustNews/files/logo2.png",//JustNews主题的logo

  "theme_github_path":"https://cdn.jsdelivr.net/gh/dongzheyu/cfblog-plus@master/themes/",//主题路径
  "themeURL" : "https://cdn.jsdelivr.net/gh/dongzheyu/cfblog-plus@master/themes/JustNews/", // 模板地址,以 "/"" 结尾
  ...
  "cacheTime" : 60*60*24*0.5, //文章在浏览器的缓存时长(秒),建议=文章更新频率
  ...
  "otherCodeD":``,//
  "otherCodeE":``,//
  "copyRight" :`Powered by <a href="https://www.cloudflare.com">Workers and Pages</a> & <a href="https://jetcpp.dpdns.org/">JetCPP </a>`,//自定义版权信息,建议保留大公无私的 Coudflare 和 作者 的链接
  "robots":`User-agent: *
...
//---对部分配置进行处理---
{
  //CFBLOG 通用变量 - 在Cloudflare Workers中，将字符串替换为实际KV对象
  if (typeof CFBLOG !== 'undefined') {
    ACCOUNT.kv_var = CFBLOG;
  }
